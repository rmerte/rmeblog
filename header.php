...
$siteadi	= $ayarcek["siteadi"]; 
 ...
 <div class="logoarea">
  ...
  <a href="<?php echo $sitebase ?>"> <img class="logoheader" src="<?php echo $logourl ?>" alt="logo" /></a>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
  ...
  <div class="dropdown-menu dropdownfix" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="'.$sitebase.'/editor.php">Yeni Yazı</a>
	<a class="dropdown-item" href="'.$sitebase.'/panel">Yönetim Paneli</a>
    <a class="dropdown-item" href="'.$sitebase.'/logout.php">Çıkış</a>
...
'; 
    ...
    <a class="loginbutton" href="'.$sitebase.'/login">Giriş</a>
  </span>';
